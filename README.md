...
- 전제 조건:
  - 데이터가 한정적이기 때문에 지역구 선정 시 모두 동일한 조건의 데이터라고 가정한다.
...
#### 1-3. 상권, 생활인구 - 쓰레기통
![image](https://github.com/HyenC/CigaretteButtBins/assets/38906574/c775f0c9-1bf8-4b97-b3de-e5881f176e98)
...
### 2. 쓰레기통 위치 추천 모델링을 위한 마포구 선정 이유 (전제 조건 적용)
