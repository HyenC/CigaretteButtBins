...
쓰레기통 위치에 영향을 미치는 요인으로 투기지역, 흡연구역, 담배소매인, 상권, 생활인구를 비교했다. 그 중 흡연구역, 투기지역, 담배소매인, 상권이 쓰레기통 입지에 영향을 미칠 수 있는 요인으로 파악된다. 해당 요인을 활용하여 K-means를 활용한 앙상블 기법을 통해 쓰레기통 입지 추천 모델을 개발하여 적절한 위치에 담배꽁초 전용 쓰레기통을 설치하여 투기를 줄이고, 환경오염 감소 효과를 기대한다.
<div>
